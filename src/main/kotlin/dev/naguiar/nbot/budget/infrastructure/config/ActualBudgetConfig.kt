...
class ActualBudgetConfig {
    ...
    ): AccountsApi = createClient(builder, properties.url, properties.apiKey, AccountsApi::class.java)

    @Bean
    fun payeesApi(
        builder: RestClient.Builder,
        properties: ActualBudgetProperties,
    ): PayeesApi = createClient(builder, properties.url, properties.apiKey, PayeesApi::class.java)
